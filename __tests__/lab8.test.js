...
describe('Basic user flow for Website', () => {
  ...
  it('Clicking the "Add to Cart" button should change button text', async () => {
    ...
    // click after to have the button back to "Add to Cart"
    await button.click();
  }, 2500);
  ...
  it('Checking number of items in cart on screen', async () => {
    ...
    let car_count = await page.$('#cart-count');
    let innerText = await car_count.getProperty('innerText');
  ...
  it('Checking number of items in cart on screen after reload', async () => {
    ...
    var innerText = await page.$('#cart-count');
    var innerTextOutput = await innerText.getProperty('innerText');
    expect(innerTextOutput['_remoteObject'].value).toMatch(/20/);
